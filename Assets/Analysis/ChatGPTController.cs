...
public class ChatAnalysisController : MonoBehaviour
{
    ...
    private void startConversation()
    {
        ...
        {
            new ChatMessage(ChatMessageRole.System, "너는 대화 상대가 진로 검사 결과를 입력하면 그 결과를 분석해서 적성에 맞는 직업들이 무엇이 있는지 추천해 주는 역할이야.")
        };

        inputField.text = "";
        string startString = "안녕하세요! 진로 검사 결과를 입력하시면 당신에게 맞는 직업을 추천해 드리겠습니다!";
